    ...
    def get_files_name_list(self):
        ...
        for per_folder in folder_list:
            ...
            for one_folder in folder_list:
                if one_folder == 'lidar':
                    pcd_path = '/home/lab/Lidar_Openpcdet_ST3D/OpenPCDet/data/mydata/lidar'

                if one_folder == 'label':
                    label_path = '/home/lab/Lidar_Openpcdet_ST3D/OpenPCDet/data/mydata/label' # #/home/algo-4/work/ST3D/data/mydata/label
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__()>1 and sys.argv[1] == 'create_mydata_infos':
        ...
        create_mydata_infos(
            ...
            data_path= ROOT_DIR / 'data' / 'mms',
            save_path= ROOT_DIR / 'data' / 'mms'
        )
